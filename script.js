// Nota: obtenerFechaLocal(), obtenerHoraLocal() y obtenerFechaHoraLocal()
// ahora viven en data.js (antes estaban duplicadas aquí con un bug de
// zona horaria forzada a México GMT-6).
